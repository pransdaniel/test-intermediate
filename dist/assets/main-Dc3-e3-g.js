(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function t(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=t(o);fetch(o.href,r)}})();class v{constructor(){this.routes=[],this.currentUrl="",window.addEventListener("hashchange",()=>{console.log("Hash changed to:",window.location.hash),this._loadRouteWithTransition()})}addRoute(e,t,i={}){return this.routes.push({url:e,callback:t,requiresAuth:i.requiresAuth||!1,guestOnly:i.guestOnly||!1}),this}setFallback(e){return this.fallbackCallback=e,this}_loadRouteWithTransition(){document.startViewTransition?document.startViewTransition(()=>{this._loadRoute()}):(this._applyFallbackTransition(),this._loadRoute())}_applyFallbackTransition(){const e=document.getElementById("mainContent");e&&(e.style.opacity="0",e.style.transition="opacity 0.3s ease",setTimeout(()=>{e.style.opacity="1"},300))}_loadRoute(){const t=window.location.hash.slice(1)||"/";this.currentUrl=t;const i=localStorage.getItem("token")!==null;console.log("Loading route:",t,"Auth:",i);const o=this.routes.find(r=>r.url===t);if(o){if(o.requiresAuth&&!i&&t!=="/masuk"){console.log("Halaman memerlukan login. Mengalihkan ke halaman login..."),this.navigateTo("/masuk");return}if(o.guestOnly&&i&&t!=="/"){console.log("Halaman hanya untuk tamu. Mengalihkan ke beranda..."),this.navigateTo("/");return}try{o.callback()}catch(r){console.error("Error in route callback:",r)}}else this.fallbackCallback&&(console.log("Route tidak ditemukan, menggunakan fallback"),this.fallbackCallback())}navigateTo(e){if(console.log("Navigating to:",e),(window.location.hash.slice(1)||"/")===e){console.log("Already on this URL, skipping navigation");return}window.location.hash=e}init(){console.log("Router initialized"),this._loadRouteWithTransition(),this._addViewTransitionStyles()}_addViewTransitionStyles(){if(!document.getElementById("viewTransitionStyles")){const e=document.createElement("style");e.id="viewTransitionStyles",e.textContent=`
  ...
  `,document.head.appendChild(n)}window.notificationUIHelper=k;class F{constructor(){this.baseUrl="https://story-api.dicoding.dev/v1",this.isOnline=navigator.onLine,this.requestQueue=[],window.addEventListener("online",()=>{console.log("Network back online"),this.isOnline=!0,this.processRequestQueue()}),window.addEventListener("offline",()=>{console.log("Network went offline"),this.isOnline=!1})}async fetchWithTimeout(e,t={},i=8e3){if(!this.isOnline&&!navigator.onLine)throw new Error("No internet connection");const o=new AbortController,r=setTimeout(()=>{o.abort()},i);try{const a=await fetch(e,{...t,signal:o.signal});return clearTimeout(r),a}catch(a){throw clearTimeout(r),a.name==="AbortError"?new Error("Request timeout"):a}}async fetchWithRetry(e,t={},i=2){let o;for(let r=0;r<=i;r++)try{return console.log(`API request attempt ${r+1}/${i+1}: ${e}`),await this.fetchWithTimeout(e,t)}catch(a){if(o=a,console.warn(`API request attempt ${r+1} failed:`,a.message),a.message.includes("No internet connection")||a.message.includes("401")||a.message.includes("403"))break;if(r<i){const s=Math.min(1e3*Math.pow(2,r),5e3);console.log(`Waiting ${s}ms before retry...`),await new Promise(l=>setTimeout(l,s))}}throw o}async register(e,t,i){try{if(console.log("Registering user:",e,t),!this.isOnline)throw new Error("Tidak dapat mendaftar saat offline. Silakan coba lagi saat online.");const r=await(await this.fetchWithRetry(`${this.baseUrl}/register`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:e,email:t,password:i})})).json();if(console.log("Register response:",r),r.error)throw new Error(r.message);return r}catch(o){throw console.error("Registration error:",o),o.message.includes("No internet connection")||o.message.includes("timeout")?new Error("Tidak ada koneksi internet. Periksa koneksi Anda dan coba lagi."):new Error(`Gagal mendaftar: ${o.message}`)}}async login(e,t){try{if(console.log("Login attempt for:",e),!this.isOnline)throw new Error("Tidak dapat login saat offline. Silakan coba lagi saat online.");const o=await(await this.fetchWithRetry(`${this.baseUrl}/login`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:e,password:t})})).json();if(console.log("Login response:",o),o.error)throw new Error(o.message);return localStorage.setItem("token",o.loginResult.token),localStorage.setItem("user",JSON.stringify(o.loginResult)),o}catch(i){throw console.error("Login error:",i),i.message.includes("No internet connection")||i.message.includes("timeout")?new Error("Tidak ada koneksi internet. Periksa koneksi Anda dan coba lagi."):new Error(`Gagal login: ${i.message}`)}}async getAllStories(){try{const e=localStorage.getItem("token");if(console.log("Getting stories with token:",e?"Token exists":"No token"),!e)throw new Error("Token tidak ditemukan. Silakan login terlebih dahulu.");if(!this.isOnline){console.log("Offline - trying to get cached stories");const o=await this.getCachedStories();if(o&&o.length>0)return console.log("Returning cached stories:",o.length),o;throw new Error("Tidak ada koneksi internet dan tidak ada data tersimpan")}const i=await(await this.fetchWithRetry(`${this.baseUrl}/stories?location=1`,{headers:{Authorization:`Bearer ${e}`}})).json();if(console.log("Stories response:",i),i.error)throw new Error(i.message);return await this.cacheStories(i.listStory),i.listStory}catch(e){if(console.error("Error fetching stories:",e),e.message.includes("Token tidak ditemukan"))return window.router&&window.router.navigateTo("/masuk"),[];if(this.isOnline){console.log("Online request failed, trying cached stories");const t=await this.getCachedStories();if(t&&t.length>0)return console.log("Returning cached stories as fallback"),t}return[]}}async addNewStory(e,t,i,o){try{const r=localStorage.getItem("token");if(console.log("Adding new story with token:",r?"Token exists":"No token"),!r)throw new Error("Token tidak ditemukan. Silakan login terlebih dahulu.");const a=new FormData;if(a.append("description",e),a.append("photo",t,"photo.jpg"),i!==null&&o!==null&&(a.append("lat",i),a.append("lon",o)),!this.isOnline)return console.log("Offline - queueing story for later upload"),await this.queueOfflineStory({description:e,photoBlob:t,lat:i,lon:o,token:r}),{error:!1,message:"Cerita disimpan offline dan akan diunggah saat online"};console.log("Sending request to add story");const l=await(await this.fetchWithRetry(`${this.baseUrl}/stories`,{method:"POST",headers:{Authorization:`Bearer ${r}`},body:a})).json();if(console.log("Add story response:",l),l.error)throw new Error(l.message);return l}catch(r){if(console.error("Error adding story:",r),r.message.includes("No internet connection")||r.message.includes("timeout")){console.log("Network error - queueing story for later upload");const a=localStorage.getItem("token");return await this.queueOfflineStory({description:e,photoBlob:t,lat:i,lon:o,token:a}),{error:!1,message:"Cerita disimpan offline dan akan diunggah saat online"}}throw new Error(`Gagal menambah cerita: ${r.message}`)}}async cacheStories(e){try{if(window.indexedDBHelper)await window.indexedDBHelper.saveOfflineStories(e),console.log("Stories cached in IndexedDB");else{const t=JSON.stringify(e);t.length<2e6&&(localStorage.setItem("cached_stories",t),localStorage.setItem("cached_stories_timestamp",Date.now().toString()),console.log("Stories cached in localStorage"))}}catch(t){console.warn("Failed to cache stories:",t)}}async getCachedStories(){try{if(window.indexedDBHelper)return await window.indexedDBHelper.getOfflineStories()||[];{const e=localStorage.getItem("cached_stories"),t=localStorage.getItem("cached_stories_timestamp");return e&&t&&Date.now()-parseInt(t)<24*60*60*1e3?JSON.parse(e):[]}}catch(e){return console.warn("Failed to get cached stories:",e),[]}}async queueOfflineStory(e){try{const t={id:Date.now().toString(),...e,timestamp:Date.now()};if(window.indexedDBHelper)await window.indexedDBHelper.saveOfflineStory(t),console.log("Story queued in IndexedDB");else{const i=JSON.parse(localStorage.getItem("offline_story_queue")||"[]");i.push(t),localStorage.setItem("offline_story_queue",JSON.stringify(i)),console.log("Story queued in localStorage")}if("serviceWorker"in navigator&&"sync"in window.ServiceWorkerRegistration.prototype)try{await(await navigator.serviceWorker.ready).sync.register("background-sync-story"),console.log("Background sync registered")}catch(i){console.warn("Background sync registration failed:",i)}}catch(t){throw console.error("Failed to queue offline story:",t),t}}async processRequestQueue(){if(this.isOnline)try{console.log("Processing offline story queue...");let e=[];if(window.indexedDBHelper?e=await window.indexedDBHelper.getOfflineStoryQueue()||[]:e=JSON.parse(localStorage.getItem("offline_story_queue")||"[]"),e.length===0){console.log("No offline stories to process");return}console.log(`Processing ${e.length} offline stories`);for(const t of e)try{const i=new FormData;if(i.append("description",t.description),i.append("photo",t.photoBlob,"photo.jpg"),t.lat!==null&&t.lon!==null&&(i.append("lat",t.lat),i.append("lon",t.lon)),(await this.fetchWithTimeout(`${this.baseUrl}/stories`,{method:"POST",headers:{Authorization:`Bearer ${t.token}`},body:i})).ok){if(console.log("Offline story uploaded successfully:",t.id),window.indexedDBHelper)await window.indexedDBHelper.removeOfflineStory(t.id);else{const r=e.filter(a=>a.id!==t.id);localStorage.setItem("offline_story_queue",JSON.stringify(r))}"serviceWorker"in navigator&&navigator.serviceWorker.ready.then(r=>{r.showNotification("Cerita Diunggah",{body:"Cerita offline berhasil diunggah!",icon:"/Submission-Intermediate/icons/icon-192x192.png"})})}}catch(i){console.error("Failed to upload offline story:",t.id,i)}}catch(e){console.error("Error processing offline queue:",e)}}isAuthenticated(){return!!localStorage.getItem("token")}logout(){localStorage.removeItem("token"),localStorage.removeItem("user")}getCurrentUser(){const e=localStorage.getItem("user");return e?JSON.parse(e):null}getNetworkStatus(){return{isOnline:this.isOnline&&navigator.onLine,lastCheck:Date.now()}}}const M=new F;window.apiService=M;class _{constructor(e){this.apiService=e,console.log("StoryModel initialized with apiService")}async getAllStories(){try{console.log("StoryModel.getAllStories: Requesting stories from API");const e=await this.apiService.getAllStories();return!e||!Array.isArray(e)?(console.warn("StoryModel: Invalid stories data received from API"),[]):(console.log(`StoryModel: Successfully retrieved ${e.length} stories`),e)}catch(e){throw console.error("StoryModel: Error getting stories:",e),new Error(`Failed to load stories: ${e.message}`)}}async addNewStory(e,t,i,o){try{if(console.log("StoryModel.addNewStory: Adding new story"),!e||!t)throw new Error("Description and photo are required");return await this.apiService.addNewStory(e,t,i,o)}catch(r){throw console.error("StoryModel: Error adding story:",r),new Error(`Failed to add story: ${r.message}`)}}}window.StoryModel=_;class x{constructor(){this.render()}render(){const e=document.querySelector("footer");if(e&&(e.innerHTML=`
    ...
    `;const s=this.querySelector(".story-location");s&&s.addEventListener("click",l=>{l.preventDefault();const c=parseFloat(s.dataset.lat),u=parseFloat(s.dataset.lon),g=new CustomEvent("story-location-click",{detail:{lat:c,lon:u,name:e,description:i},bubbles:!0});this.dispatchEvent(g)})}}customElements.define("story-card",I);window.StoryCard=I;class D{constructor(){this._container=document.querySelector("#mainContent"),this._map=null,this._marker=null,this._position={lat:null,lon:null},this._cameraActive=!1,this._canvas=document.createElement("canvas"),this._presenter=null,this._photoBlob=null,this._setupNavigationListener()}setPresenter(e){this._presenter=e}_setupNavigationListener(){window.addEventListener("hashchange",()=>{this._cameraActive&&(console.log("Navigation detected, stopping camera"),this._stopCameraAndCleanup())}),window.addEventListener("beforeunload",()=>{this._cameraActive&&(console.log("Page unload detected, stopping camera"),this._stopCameraAndCleanup())})}_stopCameraAndCleanup(){console.log("Stopping camera and cleaning up resources"),cameraHelper.stopCamera(),this._cameraActive=!1;const e=document.getElementById("cameraFeed");e&&(e.srcObject=null)}render(){console.log("Rendering add story page"),this._container.innerHTML=`
      <div class="container">
    ...
    `,setTimeout(()=>{this._initMap(),this._initCameraButtons(),this._initFormSubmit(),console.log("Add story page components initialized")},100)}_initMap(){if(console.log("Initializing map"),!document.getElementById("pickLocationMap")){console.error("Map container not found");return}try{this._map=L.map("pickLocationMap").setView([-2.5489,118.0149],5),L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'}).addTo(this._map),this._map.on("click",t=>{this._updateMarker(t.latlng.lat,t.latlng.lng)}),console.log("Map initialized successfully")}catch(t){console.error("Error initializing map:",t)}}_updateMarker(e,t){console.log("Updating marker position:",e,t),this._position.lat=e,this._position.lon=t,document.getElementById("latValue").textContent=e.toFixed(6),document.getElementById("lonValue").textContent=t.toFixed(6),this._marker&&this._map.removeLayer(this._marker),this._marker=L.marker([e,t]).addTo(this._map),this._marker.bindPopup("Lokasi cerita Anda").openPopup()}_initCameraButtons(){console.log("Initializing camera buttons and file input");const e=document.getElementById("startCameraBtn"),t=document.getElementById("captureBtn"),i=document.getElementById("retakeBtn"),o=document.getElementById("uploadImage"),r=document.getElementById("cameraFeed"),a=document.getElementById("capturedImage");if(!e||!t||!i||!o||!r||!a){console.error("Camera or file input elements not found");return}r.style.display="none",a.style.display="none";let s=!1;e.addEventListener("click",async()=>{console.log("Start camera button clicked"),!this._cameraActive&&!s&&(e.disabled=!0,o.disabled=!0,r.style.display="block",a.style.display="none",await cameraHelper.startCamera(r)?(console.log("Camera started successfully"),this._cameraActive=!0,t.disabled=!1,i.disabled=!0):(console.error("Failed to start camera"),e.disabled=!1,o.disabled=!1,r.style.display="none",this.showMessage("Gagal memulai kamera. Pastikan kamera diizinkan.","error")))}),t.addEventListener("click",async()=>{if(console.log("Capture button clicked"),this._cameraActive){const l=cameraHelper.captureImage(r,this._canvas);l?(console.log("Image captured successfully"),a.src=l,r.style.display="none",a.style.display="block",t.disabled=!0,i.disabled=!1,o.disabled=!1,this._cameraActive=!1,this._photoBlob=await this._dataURLtoBlob(l),this._photoBlob.size>1e6&&(this._photoBlob=await this._compressImage(this._photoBlob),a.src=URL.createObjectURL(this._photoBlob))):(console.error("Failed to capture image"),this.showMessage("Gagal mengambil gambar. Coba lagi.","error"))}}),i.addEventListener("click",async()=>{console.log("Retake button clicked"),a.style.display="none",this._photoBlob=null,i.disabled=!0,s?(o.value="",o.disabled=!1,e.disabled=!1,s=!1):(r.style.display="block",await cameraHelper.startCamera(r)?(console.log("Camera restarted successfully"),this._cameraActive=!0,t.disabled=!1,o.disabled=!0):(console.error("Failed to restart camera"),e.disabled=!1,o.disabled=!1,r.style.display="none",this.showMessage("Gagal memulai kamera. Pastikan kamera diizinkan.","error")))}),o.addEventListener("change",async l=>{console.log("File selected");const c=l.target.files[0];if(c){if(!c.type.match("image/jpeg|image/png")){this.showMessage("Hanya file JPEG atau PNG yang diperbolehkan!","error"),o.value="";return}c.size>1e6?this._photoBlob=await this._compressImage(c):this._photoBlob=c,a.src=URL.createObjectURL(this._photoBlob),a.style.display="block",r.style.display="none",e.disabled=!0,t.disabled=!0,i.disabled=!1,s=!0}})}async _dataURLtoBlob(e){return await(await fetch(e)).blob()}async _compressImage(e){const t=new Image;t.src=URL.createObjectURL(e),await new Promise(c=>t.onload=c);const i=document.createElement("canvas"),o=i.getContext("2d"),r=1024;let a=t.width,s=t.height;a>s?a>r&&(s*=r/a,a=r):s>r&&(a*=r/s,s=r),i.width=a,i.height=s,o.drawImage(t,0,0,a,s);const l=i.toDataURL("image/jpeg",.7);return await this._dataURLtoBlob(l)}_initFormSubmit(){console.log("Initializing form submission");const e=document.getElementById("addStoryForm");if(!e){console.error("AddStoryForm not found!");return}e.addEventListener("submit",async t=>{t.preventDefault(),console.log("Form submitted");const i=document.getElementById("description").value.trim(),o=document.getElementById("capturedImage"),r={description:i,hasImage:o.src&&o.src!=="about:blank"&&o.style.display!=="none",position:{...this._position}};this._presenter?this._presenter.submitStory(r):(console.error("Presenter not set"),this.showMessage("Terjadi kesalahan: presenter belum terdaftar","error"))})}validateForm(){const e=document.getElementById("description").value.trim();document.getElementById("capturedImage");const{lat:t,lon:i}=this._position;let o=!1,r="";return e?this._photoBlob?this._photoBlob.size>1e6?(r="Ukuran gambar melebihi 1MB!",o=!0):(t===null||i===null)&&(r="Pilih lokasi pada peta!",o=!0):(r="Gambar belum diambil atau dipilih!",o=!0):(r="Cerita tidak boleh kosong.",o=!0),o?(this.showMessage(r,"error"),!1):!0}async getStoryData(){const e=document.getElementById("description").value.trim(),{lat:t,lon:i}=this._position;return{description:e,photoBlob:this._photoBlob,lat:t,lon:i}}showMessage(e,t="success"){console.log(`Showing ${t} message:`,e);const i=document.getElementById("messageContainer");i&&(i.innerHTML=`<div class="message ${t}"><p>${e}</p></div>`,setTimeout(()=>{i.innerHTML=""},3e3))}showLoading(){const e=document.getElementById("loadingIndicator");e&&(e.style.display="flex")}hideLoading(){const e=document.getElementById("loadingIndicator");e&&(e.style.display="none")}showSuccess(e){this.showMessage(e,"success"),this.resetForm()}resetForm(){const e=document.getElementById("description"),t=document.getElementById("capturedImage"),i=document.getElementById("uploadImage");e&&(e.value=""),t&&(t.style.display="none",t.src=""),i&&(i.value=""),this._photoBlob=null,this._marker&&(this._map.removeLayer(this._marker),this._marker=null),this._position={lat:null,lon:null};const o=document.getElementById("latValue"),r=document.getElementById("lonValue");o&&r&&(o.textContent="Belum dipilih",r.textContent="Belum dipilih"),this._cameraActive&&this._stopCameraAndCleanup();const a=document.getElementById("startCameraBtn"),s=document.getElementById("captureBtn"),l=document.getElementById("retakeBtn");a&&s&&l&&i&&(a.disabled=!1,s.disabled=!0,l.disabled=!0,i.disabled=!1)}showError(e){this.showMessage(e,"error")}destroy(){console.log("Destroying add story view"),this._cameraActive&&this._stopCameraAndCleanup(),this._map&&(this._map.remove(),this._map=null)}scheduleNavigation(e,t=1e3){setTimeout(e,t)}navigateToRoute(e){window.router&&window.router.navigateTo(e)}}window.AddStoryView=D;console.log("AddStoryView exported to window");class R{constructor(){this.container=document.querySelector("#mainContent"),this.presenter=null,this.map=null,this.markers=[],this.storiesContainer=null,this.loadingIndicator=null}setPresenter(e){this.presenter=e,console.log("HomeView: Presenter set successfully")}render(){console.log("HomeView render called"),document.title="Mystory",this.container.innerHTML="",this.container.innerHTML=`
    ...
    `,this._addStyles(),this.storiesContainer=document.getElementById("storiesContainer"),this.loadingIndicator=document.getElementById("loadingIndicator"),this.storiesContainer||console.error("storiesContainer element not found"),this.loadingIndicator||console.error("loadingIndicator element not found"),this.showLoading(),setTimeout(()=>{this.presenter?(console.log("HomeView: Requesting stories from presenter"),this.presenter.loadStories()):(console.error("Presenter not set in HomeView"),this.renderError("Error: Unable to load stories. Presenter not initialized."))},100)}renderStories(e){if(console.log("HomeView.renderStories called with",e?e.length:0,"stories"),this.hideLoading(),!e||e.length===0){this.renderEmptyState();return}this.storiesContainer?(this.storiesContainer.innerHTML="",e.forEach(t=>{const i=document.createElement("div");i.className="story-card",i.innerHTML=`
      ...
      `,document.head.appendChild(e)}}}window.HomeView=R;console.log("HomeView exported to window");class z{constructor(){this.container=document.querySelector("#mainContent"),this.presenter=null}setPresenter(e){this.presenter=e}render(){this.container.innerHTML=`
    ...
    `,setTimeout(()=>{this._initMap()},100)}_initMap(){console.log("Initializing map");try{this._map=L.map("storyMap").setView([-2.5489,118.0149],5),L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'}).addTo(this._map),this._presenter?this._presenter.loadStoriesForMap():console.error("MapView: Presenter not set")}catch(e){console.error("Error initializing map:",e)}}displayStories(e){if(console.log("MapView: Displaying stories on map"),!this._map){console.error("Map not initialized");return}this._clearMarkers(),e.filter(t=>t.lat&&t.lon).forEach(t=>{const i=L.marker([t.lat,t.lon]).addTo(this._map).bindPopup(`
      ...
      `;const i=document.getElementById("retryMapBtn");i&&this._presenter&&i.addEventListener("click",()=>{this.render()})}}destroy(){this._map&&(this._map.remove(),this._map=null)}}window.MapView=$;console.log("MapView exported to window");class q{constructor(){this.container=document.querySelector("#mainContent"),this.presenter=null}setPresenter(e){this.presenter=e}render(){console.log("FavoritesView render called"),this.container.innerHTML=`
